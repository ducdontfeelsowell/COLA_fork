...
import random
class Population:
    def __init__(self, obj_num, pbuffer_num=500, pbuffer_size=2):
        self.sample_batch = [] # all samples in population
        self.pbuffer_num = pbuffer_num
        self.pbuffer_size = pbuffer_size
    ...
    def uniformly_select_one_samples(self):
        ...
        UpdatedList = random.sample(self.sample_batch, 1)
