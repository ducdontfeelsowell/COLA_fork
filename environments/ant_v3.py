...
class AntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step(self, a):
        ...
        third_reward = 4.0 - 0.5 * np.square(a).sum() #+ survive_reward
        ...
        ob = self._get_obs()
        return ob, np.array([vx_reward, vy_reward, third_reward]), done, {'obj': np.array([vx_reward, vy_reward, third_reward])}
