...
class SSNE:
    def __init__(self, pop_size , frac, mut_strength,  elite_size):
        self.current_gen = 0
    ...
    def mutate_inplace(self, gene):
        ...
        mut_strength =  self.mut_strength # 0.000005 #0.0001#0.000005# 0.1#0.0001#0.1
        num_mutation_frac = self.frac
        super_mut_strength =  self.mut_strength * 100 #0.0005 #0.01#0.0005#10 #0.01 #10
        super_mut_prob = 0.05
